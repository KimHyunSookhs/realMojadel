...
import '../../TradePage/TradeBoardList/TradeBoardListItem.dart';

class MyTradecontents extends StatefulWidget {
  const MyTradecontents({super.key});

  @override
  State<MyTradecontents> createState() => _MyTradecontentsState();
}

class _MyTradecontentsState extends State<MyTradecontents> {
  ...
  Future<void> _fetchMyBoards() async {
    final String uri =
        'http://13.125.228.152:4000/api/v1/trade/trade-board/user-board-list/$userEmail';
    try {
