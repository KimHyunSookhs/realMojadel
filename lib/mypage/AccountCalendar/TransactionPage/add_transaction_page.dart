...
class _AddTransactionPageState extends State<AddTransactionPage> {
  ...
  Future<void> _loadCategories() async {
    ...
    final String uri = 'http://13.125.228.152:4000/api/v1/account-log/custom-type';
    final prefs = await SharedPreferences.getInstance();
  ...
  Future<void> _saveCategoryToServer(String categoryName) async {
    try {
      final url = Uri.parse('http://13.125.228.152:4000/api/v1/account-log/custom-type');
  ...
  Future<void> _deleteCategory(String categoryName) async {
    ...
    if (customTypeNumber != null) {
      try {
        final url = Uri.parse('http://13.125.228.152:4000/api/v1/account-log/custom-type/$customTypeNumber');
  ...
  Future<void> _saveTransaction() async {
    if (selectedCategory != null &&
      ...
      final String uri = 'http://13.125.228.152:4000/api/v1/account-log';
      try {
        final response = await http.post(
          Uri.parse(uri),
          headers: {
