...
Future<void> postComment(int postId, String content, String jwtToken) async {
  final String uri = 'http://192.168.219.109:4000/api/v1/community/board/$postId/comment';
  try {
...
Future<void> fetchComments(int postId, String jwtToken) async {
  final String uri = 'http://192.168.219.109:4000/api/v1/community/board/$postId/comment-list';
  try {
